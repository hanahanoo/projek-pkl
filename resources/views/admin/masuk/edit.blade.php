      ...
      <form action="{{ route('admin.masuk.update', $suratMasuk->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-floating form-floating-outline mb-6">
          <input
            ...
            placeholder="0000/XXX/00/0000" name="no_surat" value="{{$suratMasuk->no_surat}}" />
        ...
        <div class="form-floating form-floating-outline mb-6">
          <input type="text" class="form-control" placeholder="PT.XXX / Mr.XX / Mrs.XX"
            id="pengirim" name="pengirim" value="{{$suratMasuk->pengirim}}"/>
          <label for="pengirim">Pengirim</label>
        </div>

        <div class="form-floating form-floating-outline mb-6">
          <textarea class="form-control h-px-100" id="perihal" placeholder="Perihal Surat"
            name="perihal">{{$suratMasuk->perihal}}</textarea>
