      ...
      <form action="{{ route('keluar.update', $suratKeluar->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-floating form-floating-outline mb-6">
          <input
            ...
            placeholder="0000/XXX/00/0000" name="no_surat" value="{{$suratKeluar->no_surat}}" />
        ...
        <div class="form-floating form-floating-outline mb-6">
          <input type="text" class="form-control" placeholder="PT.XXX / Mr.XX / Mrs.XX"
            id="tujuan" name="tujuan" value="{{$suratKeluar->tujuan}}"/>
          <label for="tujuan">Tujuan</label>
        </div>

        <div class="form-floating form-floating-outline mb-6">
          <textarea class="form-control h-px-100" id="perihal" placeholder="Perihal"
            name="perihal">{{$suratKeluar->perihal}}</textarea>
